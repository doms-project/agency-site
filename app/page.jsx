...
function HeroSection({ onOpenMobileNav, typedText, isMobileNavOpen = false }) {
  ...
  return (
    <section
      ...
      style={{ backgroundColor: 'transparent', marginTop: '0 !important' }}
      role="region"
    ...
    >
      ...
      <section className="hero relative z-10 w-full flex flex-col justify-center items-center pb-16 mb-0 overflow-hidden" style={{ paddingTop: '5rem' }}>
