 ...
 <div class="max-w-7xl mx-auto">
  <div class="flex flex-col md:grid md:grid-cols-12 gap-4 md:gap-6 mb-6">
   ...
   <div class="flex flex-col md:hidden items-center gap-4 mb-8">
    <a class="flex items-center gap-3 text-white/70 hover:text-[#7BB9E8] transition-all duration-200 text-base font-medium group" href="mailto:Yomarketingco@gmail.com">
   ...
   <div class="hidden md:flex flex-col items-start text-left md:col-span-3">
    ...
    <div class="flex flex-col gap-2">
     <a class="flex items-center gap-2 text-white/70 hover:text-[#7BB9E8] transition-all duration-200 text-xs font-medium group" href="mailto:Yomarketingco@gmail.com">
      ...
      <span class="break-all">Yomarketingco@gmail.com</span>
     </a>
