export const approachSectionHtml = String.raw`<section class="w-full py-20 bg-gradient-to-b from-[#181c22] via-[#10151a] to-[#181c22] relative overflow-hidden" id="approach" style="scroll-margin-top:120px">
 <div class="absolute inset-0 opacity-10">
  ...
  <div class="absolute top-3/4 right-1/4 w-64 h-64 bg-[#5fa6db] rounded-full mix-blend-multiply filter blur-3xl animate-pulse delay-1000">
  </div>
 </div>
 <div class="max-w-6xl mx-auto px-4 md:px-6 relative z-10">
  ...
  <div class="text-center">
   <div class="relative inline-block">
    ...
    <div class="absolute -inset-2 bg-gradient-to-r from-[#7BB9E8]/20 to-[#5fa6db]/20 rounded-2xl blur-lg opacity-0 group-hover:opacity-100 transition-opacity duration-500 -z-10">
    </div>
   </div>
  </div>
 </div>
