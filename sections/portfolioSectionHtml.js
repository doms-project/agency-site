export const portfolioSectionHtml = String.raw`<section class="py-20 bg-gradient-to-b from-[#0a0a0a] via-[#10151a] to-[#181c22] overflow-hidden relative" id="portfolio" style="scroll-margin-top:120px">
 <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
  <div class="text-center mb-6 mt-16">
   ...
   <div class="w-20 h-1 rounded-full bg-[#7BB9E8] mb-6 mt-2 mx-auto">
   </div>
  ...
  <div class="relative mb-16">
   <div class="overflow-hidden">
    <div class="flex gap-3 w-fit portfolio-carousel-scroll">
      ...
      <div class="card-content relative rounded-3xl overflow-hidden shadow-2xl cursor-pointer" style="will-change:transform, opacity">
       ...
       <div class="absolute bottom-0 left-0 right-0 h-1/2 bg-gradient-to-t from-black/80 via-black/40 to-transparent flex items-end justify-center pb-8 z-20">
        <div class="bg-white text-gray-900 px-4 py-2 sm:px-6 sm:py-3 rounded-xl font-semibold text-xs sm:text-sm shadow-lg border border-white/30 inline-flex items-center gap-2 z-30" style="font-family:Poppins, sans-serif">
         See Case Study
         <svg class="w-3 h-3 sm:w-4 sm:h-4" fill="none" height="12" viewbox="0 0 12 12" width="12">
          <path d="M3.5 3.5H8.5V8.5M8.5 3.5L3.5 8.5" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5">
          </path>
         </svg>
        </div>
       </div>
  ...
  <div class="text-center mt-20">
   <div class="max-w-4xl mx-auto">
    ...
    <button type="button" class="inline-flex items-center justify-center gap-2 whitespace-nowrap ring-offset-background focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&amp;_svg]:pointer-events-none [&amp;_svg]:size-4 [&amp;_svg]:shrink-0 h-auto md:h-11 bg-[#7BB9E8] hover:bg-[#5fa6d6] text-white px-6 py-3 md:px-10 md:py-4 rounded-xl font-semibold text-base md:text-lg shadow-xl hover:shadow-2xl transform hover:scale-105 transition-all duration-300 border border-[#7BB9E8]/30 w-full sm:w-auto">
