export const trustSectionHtml = String.raw`<section class="w-full py-20 md:py-24 bg-gradient-to-b from-[#0a0a0a] via-[#10151a] to-[#0a0a0a] relative overflow-hidden">
 <div class="max-w-5xl mx-auto px-4 md:px-8 relative z-10">
  <div class="text-center mb-16 pt-8">
   <div class="flex items-center justify-center mb-6">
    <div class="flex items-center gap-2 bg-[#00B67A] px-4 py-2 rounded-lg shadow-lg">
   ...
   <div class="flex justify-center mb-4">
    <div class="flex items-center gap-1">
     <svg class="w-6 h-6 md:w-7 md:h-7 text-yellow-400 fill-current" viewbox="0 0 20 20">
  ...
  <div class="relative max-w-4xl mx-auto mb-8">
   <div class="bg-white/95 backdrop-blur-sm border border-gray-200/50 rounded-2xl p-6 md:p-8 shadow-2xl relative overflow-hidden min-h-[420px] md:min-h-[380px] flex flex-col">
    <div class="absolute inset-0 bg-gradient-to-br from-[#00B67A]/5 to-transparent rounded-2xl">
    </div>
    <div class="relative z-10 flex flex-col h-full">
     ...
     <div class="flex items-center justify-between pt-4 border-t border-gray-200 mt-auto">
      <div class="flex items-center gap-3">
       <div class="w-10 h-10 bg-[#00B67A] rounded-full flex items-center justify-center text-white font-bold text-lg flex-shrink-0">
        K
       </div>
       <div>
  ...
  <div class="flex justify-center mt-8 gap-1.5">
   <button aria-label="Go to review 1" class="w-1.5 h-1.5 rounded-full transition-opacity duration-200 bg-white opacity-100">
   </button>
   <button aria-label="Go to review 2" class="w-1.5 h-1.5 rounded-full transition-opacity duration-200 bg-white opacity-30 hover:opacity-50">
   </button>
   <button aria-label="Go to review 3" class="w-1.5 h-1.5 rounded-full transition-opacity duration-200 bg-white opacity-30 hover:opacity-50">
   </button>
   <button aria-label="Go to review 4" class="w-1.5 h-1.5 rounded-full transition-opacity duration-200 bg-white opacity-30 hover:opacity-50">
   </button>
   <button aria-label="Go to review 5" class="w-1.5 h-1.5 rounded-full transition-opacity duration-200 bg-white opacity-30 hover:opacity-50">
   </button>
  </div>
