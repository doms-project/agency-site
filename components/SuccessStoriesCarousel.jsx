...
const portfolioCards = [
  ...
  },
  {
    ...
    description:
      'Modern home renovation company specializing in kitchens, bathrooms, flooring, and full custom interior transformations with clean modern craftsmanship.',
    stats: [
      { label: 'Google Search Ranking', value: 'Top 3' },
      { label: 'Organic Traffic Growth', value: '180%' },
      { label: 'Local Reach Increase', value: '4x' },
    ],
    link: 'https://flowrenovations.com/',
    design: {
      brightness: 1.2,
      contrast: 1.3,
      overlay: { from: '38', via: '52', to: '80' },
  ...
  {
    id: 9,
    title: 'Port City Home Buyers',
    backgroundImage: '/uploads/port%20city%20home%20buyer%20back.jpeg',
    logo: '/uploads/portcity%20home%20buyer%20logo.png',
    description:
