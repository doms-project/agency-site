  ...
  useEffect(() => {
    ...
    const initAnimation = () => {
      ...
      const scriptLines = [
        ...
        "  if (!isVisible) return;",
        "",
        "  // Frame rate limiting (same for mobile and desktop)",
        ...
        "",
        "  // Smooth zoom interpolation - move camera closer along direction vector (same for mobile and desktop)",
        ...
        "",
        "  // Teleport effect - enhance distortion and effects during zoom (same for mobile and desktop)",
        "  const teleportIntensity = currentZoom * 0.8;",
        "  lensingPass.uniforms.teleportIntensity.value = teleportIntensity;",
        "  // Enhanced bloom intensity for better visual quality",
        "  const baseBloom = quality === 'high' ? 1.0 : 0.8;",
        "  const enhancedBloom = baseBloom + teleportIntensity * (quality === 'high' ? 0.5 : 0.4); // Enhanced bloom for better quality",
